...
/**
 * Based on the GifActor class of @author Michael Berry on @version 10/09/08
 ...
 * 
 * @author Michael Berry, Frederick Clark
 * @version May 16, 2012
 * 
 */
public abstract class AnimatedStructure extends ProteinStructure{
    ...
    public AnimatedStructure(Cell cell,Size size, Shape shape) {
    ...
    public List<GreenfootImage> getImages()
    {
        ...
        images.addAll(Arrays.asList(this.images));
        return images;
    }
